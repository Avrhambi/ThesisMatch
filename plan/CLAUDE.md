...
Use CRIS faculty persons as discovery source; five institute pages validate branch membership and eligibility.
Use CRIS for publications, then ORCID/OpenAlex for completion, Crossref for DOI metadata, and legal open-access links only.
...
Use Hebrew RTL UI; technical identifiers and stored enum values remain English.
